...
export function PatioHeader() {
  return <header className="reference-header"><Link className="brand-mark" href="/"><strong>PK</strong><small>PATIO KING</small></Link><nav><Link href="/">Home</Link><Link href="/products">Products</Link><Link href="/customize">Customize</Link><Link href="/appointment">Book a Visit</Link><Link href="/projects">Projects</Link><Link href="/about">About</Link><Link href="/contact">Contact</Link></nav><div className="head-icons"><Link className="header-icon profile-icon" href="/profile" aria-label="Profile" title="Profile">♙</Link><Link className="header-icon" href="/wishlist" aria-label="Wishlist" title="Wishlist">♡</Link><Link className="cart-count" href="/cart" aria-label="Shopping cart" title="Shopping cart">Bag <span>0</span></Link></div></header>;
}
