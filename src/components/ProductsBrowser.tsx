...
import { furnitureCategories, productImages, productNames } from "./PatioShell";

const products = Array.from({ length: 24 }, (_, index) => ({
  id: index + 1,
  name: productNames[index % productNames.length],
  category: furnitureCategories[index % furnitureCategories.length],
  price: 12500 + index * 7500,
